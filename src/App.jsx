...
export default function App() {
  ...
  <a href="/quasar_company_template.html" target="_blank" rel="noopener noreferrer" className="hover:underline text-yellow-300">
    Company Template
  </a>
  <a href="/clickjacking_guide.html" target="_blank" rel="noopener noreferrer" className="hover:underline text-yellow-300">
    Mitigation Guide
  </a>
</div>
